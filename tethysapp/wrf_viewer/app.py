...
class WrfObservationsExplorer(TethysAppBase):
    ...
    name = 'WRF Observations Explorer'
    ...
    def url_maps(self):
        ...
        url_maps = (UrlMap(name='home',
                    ...
                    UrlMap(name='api',
                           url='wrf-viewer/api',
                           controller='wrf_viewer.controllers.api'),
                    UrlMap(name='get-plot',
                           url='wrf-viewer/get-plot',
                           controller='wrf_viewer.controllers.get_plot'),
                    # Get Plot controller (See controllers.py). Gets triggered when you click submit button on the homepage.
                    UrlMap(name='upload-shp',
                           url='wrf-viewer/upload-shp',
                           controller='wrf_viewer.controllers_ajax.upload_shp'),
                    # Upload Shapefile Controller (See controllers_ajax.py). Gets triggered when you click upload shapefile.
                    ...
                    UrlMap(name='api_get_polygon_values',
                           ...
                           controller='wrf_viewer.api.api_get_polygon_values'),
                    # Get values for polyon bounds API call. See api.py
                    )
